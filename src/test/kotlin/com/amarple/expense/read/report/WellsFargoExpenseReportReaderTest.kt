...
class WellsFargoExpenseReportReaderTest {
    @Test
    fun `should read Wells Fargo expenses from V1 CSV`() {
        val csvPath = this::class.java.getResource("/wellsfargo_v1_expenses.csv")!!.path
    ...
    @Test
    fun `should read Wells Fargo expenses from V2 CSV`() {
        val csvPath = this::class.java.getResource("/wellsfargo_v2_expenses.csv")!!.path
        val reader = WellsFargoExpenseReportReader()
        val result = reader.read(ExpenseReportInput(csvPath, "Joint Wells Fargo", reportType = ExpenseReportType.WellsFargo))
