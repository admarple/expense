...
class DiscoverExpenseReportReaderTest {
    ...
    fun `should read Discover expenses from CSV`() {
        ...
        assertEquals("Services", t1.discoverCategoryName)
        assertEquals(DiscoverCategory.SERVICES, t1.discoverCategory)
        ...
        assertEquals("Supermarkets", t2.discoverCategoryName)
        assertEquals(DiscoverCategory.SUPERMARKETS, t2.discoverCategory)
